"""
HabitOS Terminal Chat Interface.
...
def main():
    """Main CLI loop."""
    print("\033[96m" + "=" * 50)
    print("         HABITOS TERMINAL INTERFACE")
    print("      (6 Metrics + History Tracking)")
    print("=" * 50 + "\033[0m\n")
    ...
    try:
        ...
        response = chat_with_ai(initial_input, db)
        print("\033[96mHabitOS:\033[0m")
        ...
        while True:
            try:
                ...
                if user_input.lower() in ['exit', 'quit', 'bye', 'q']:
                    print("\033[96mHabitOS:\033[0m Session terminated. Stay optimized. 👋")
                    break
                ...
                response = chat_with_ai(chat_input, db)
